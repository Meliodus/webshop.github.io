...
const UIBasicActive = React.lazy(() =>
  import("./Pages/UIElements/Basic/Active")
);
const UIBasicPending = React.lazy(() =>
  import("./Pages/UIElements/Basic/Pending")
);
...
const routes = [
  ...
  },
  {
    ...
    exact: true,
    name: "Basic Active",
    component: UIBasicActive,
  },
  {
    path: "/basic/pending",
    exact: true,
    name: "Basic Pending",
    component: UIBasicPending,
  },
